...
import (
	...
	"jvm_go/ch08/instructions/constants"
	"jvm_go/ch08/instructions/loads"
	"jvm_go/ch08/instructions/stores"
	"jvm_go/ch08/instructions/stack"
	"jvm_go/ch08/instructions/math"
	"jvm_go/ch08/instructions/conversions"
	"jvm_go/ch08/instructions/comparisons"
	"jvm_go/ch08/instructions/control"
	"jvm_go/ch08/instructions/extended"
	"jvm_go/ch08/instructions/references"
)
