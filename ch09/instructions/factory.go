...
import (
	...
	"jvm_go/ch09/instructions/constants"
	"jvm_go/ch09/instructions/loads"
	"jvm_go/ch09/instructions/stores"
	"jvm_go/ch09/instructions/stack"
	"jvm_go/ch09/instructions/math"
	"jvm_go/ch09/instructions/conversions"
	"jvm_go/ch09/instructions/comparisons"
	"jvm_go/ch09/instructions/control"
	"jvm_go/ch09/instructions/extended"
	"jvm_go/ch09/instructions/references"
	"jvm_go/ch09/instructions/reserved"
)
