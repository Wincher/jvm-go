...
import (
	...
	"jvm_go/ch10/instructions/constants"
	"jvm_go/ch10/instructions/loads"
	"jvm_go/ch10/instructions/stores"
	"jvm_go/ch10/instructions/stack"
	"jvm_go/ch10/instructions/math"
	"jvm_go/ch10/instructions/conversions"
	"jvm_go/ch10/instructions/comparisons"
	"jvm_go/ch10/instructions/control"
	"jvm_go/ch10/instructions/extended"
	"jvm_go/ch10/instructions/references"
	"jvm_go/ch10/instructions/reserved"
)
