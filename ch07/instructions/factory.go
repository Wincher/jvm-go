...
import (
	...
	"jvm_go/ch07/instructions/constants"
	"jvm_go/ch07/instructions/loads"
	"jvm_go/ch07/instructions/stores"
	"jvm_go/ch07/instructions/stack"
	"jvm_go/ch07/instructions/math"
	"jvm_go/ch07/instructions/conversions"
	"jvm_go/ch07/instructions/comparisons"
	"jvm_go/ch07/instructions/control"
	"jvm_go/ch07/instructions/extended"
	"jvm_go/ch07/instructions/references"
)
