...
import (
	...
	"jvm_go/ch11/instructions/constants"
	"jvm_go/ch11/instructions/loads"
	"jvm_go/ch11/instructions/stores"
	"jvm_go/ch11/instructions/stack"
	"jvm_go/ch11/instructions/math"
	"jvm_go/ch11/instructions/conversions"
	"jvm_go/ch11/instructions/comparisons"
	"jvm_go/ch11/instructions/control"
	"jvm_go/ch11/instructions/extended"
	"jvm_go/ch11/instructions/references"
	"jvm_go/ch11/instructions/reserved"
)
